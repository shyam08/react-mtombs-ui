...
class ClientRegister extends Component {
    ...
    componentDidMount(){
        localStorage.setItem('CLIENT_TOKEN',this.props.match.params.token);
    }

    register(){
        
        console.log(JSON.stringify(this.state));
        axios.post(config.get('base_url')+'/register/client',this.state,{headers: {'CLIENT_TOKEN': localStorage.getItem('CLIENT_TOKEN')}})
